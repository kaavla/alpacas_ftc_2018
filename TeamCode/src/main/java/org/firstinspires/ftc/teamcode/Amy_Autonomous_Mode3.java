...
@Autonomous(name="Amy_Autonomous_Mode3", group="Amy")

public class Amy_Autonomous_Mode3 extends LinearOpMode {
...
/*
    ...
    private void myDetectionRun (int position,
        ...
        if (opModeIsActive()) {
            ...
            if (position == 1)
            {
                myEncoderDrive(1, robot.DRIVE_SPEED, 7, 10.0);
            ...
            {
                myEncoderDrive(1, robot.DRIVE_SPEED, 7, 10.0);
                rotate(75, robot.TURN_SPEED);
                myEncoderDrive(0, robot.DRIVE_SPEED, 65, 10.0);
                //POSSIBLE CODES
            ...
            {
                myEncoderDrive(1, robot.DRIVE_SPEED, 7, 40.0);
                myEncoderDrive(3, robot.DRIVE_SPEED, 29, 40.0);
            }
