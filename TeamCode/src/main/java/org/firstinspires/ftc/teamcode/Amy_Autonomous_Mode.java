...
@Autonomous(name="Amy_Autonomous_Mode", group="Amy")

public class Amy_Autonomous_Mode extends LinearOpMode {
    ...
    private void myDetectionTest (int position,
        ...
        if (opModeIsActive()) {
            ...
            if (position == 1)
            {
                ...
                myEncoderDrive(0, robot.DRIVE_SPEED, 55, 10.0);
                rotate(45, robot.TURN_SPEED);
                myEncoderDrive(0, robot.DRIVE_SPEED, 15, 10.0);
                //robot.markerServo.setPosition(-0.9);
                myEncoderDrive(3, robot.DRIVE_SPEED, 2, 10.0);
                myEncoderDrive(1, robot.DRIVE_SPEED, 83, 10.0);
                rotate(10, robot.TURN_SPEED);
                myEncoderDrive(0, robot.DRIVE_SPEED, 13, 10.0);
            }
            else if (position == 3)
            {
                myEncoderDrive(3, 0.3, 6, 5.0);
                myEncoderDrive(0, robot.TURN_SPEED, 50, 10.0);
            ...
            {
                myEncoderDrive(0, robot.DRIVE_SPEED, 68, 10.0);
                rotate(45, robot.TURN_SPEED);
                //robot.markerServo.setPosition(-0.9);
                myEncoderDrive(3, robot.DRIVE_SPEED, 2, 10.0);
                myEncoderDrive(1, robot.DRIVE_SPEED, 83, 10.0);
